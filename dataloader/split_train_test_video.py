...
class UCF101_splitter():
    ...
    def split_video(self):
	    ...
	    #To get cnn output for training video
	    #Change it back if we want to train the CNN
        self.train_video = self.name_HandstandPushups(train_video)
        self.test_video = self.name_HandstandPushups(test_video)
#self.name_HandstandPushups(train_video) #self.name_HandstandPushups(test_video)
